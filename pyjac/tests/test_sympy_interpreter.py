import os
from ..sympy_utils.sympy_interpreter import load_equations, enum_from_str
from ..core.reaction_types import reversible_type
...
def test_enum_from_str():
    assert enum_from_str(
        'reversible_type.explicit') == reversible_type.explicit
    try:
